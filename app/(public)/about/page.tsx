    ...
    <>
      ...
      <section className="px-4 py-3 md:py-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {WHY_CHOOSE_US.map((item) => (
            <div key={item.title} className="rounded-2xl bg-white/80 backdrop-blur shadow-md p-4 sm:p-6 text-center transition hover:-translate-y-1">
              {/* Image */}
      ...
      <section className="mb-5 md:mb-0 px-4 py-6 max-w-7xl mx-auto">
        ...
        <div className="grid gap-8 grid-cols-2 lg:grid-cols-4">
          {LEADERS.map((leader) => (
            <div key={leader.name} className="rounded-2xl bg-white/80 backdrop-blur shadow-md p-6 text-center">
